...
<div class="wrap">
                ...
                <div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
                    <div class="register">
                        ...
                        <form method="post" action="login" id="login-form">
                            ...
                            <input placeholder="Phone" class="lock" type="password" name="phone" required="">
    ...
    <div class="copy-right">
        <div class="wrap">
            <p>&copy; 2016 Cool Login Form. All Rights Reserved | Design by <a href="http://w3layouts.com">W3layouts</a>
            </p>
        </div>
    </div>
    <!--//end-copyright-->
